...
public class App {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("8 - Relatório de Assistência");
    ...
    private static Equipamento cadastrarEquipamento(Scanner sc) {
        ...
        System.out.print("Nome do cliente responsável: ");
        equipamento.setNomeCliente(sc.nextLine());
   ...
   private static void buscarCliente(Scanner sc) {
    ...
    private static void relatorioAssistencia() {
        System.out.println("\n=== RELATÓRIO DE ASSISTÊNCIA ===");

        if (clientes.isEmpty() && equipamentos.isEmpty()) {
            System.out.println("Não há clientes nem equipamentos cadastrados.");
            return;
        }
        ...
        for (Cliente cliente : clientes) {
            List<Equipamento> equipamentosCliente = new ArrayList<>();

            for (Equipamento equipamento : equipamentos) {
                if (cliente.getNome() != null
                        && cliente.getNome().equalsIgnoreCase(equipamento.getNomeCliente())) {
            ...
            if (!equipamentosCliente.isEmpty()) {
                ...
                System.out.println("CPF: " + cliente.getCpf());
                System.out.println("Telefone: " + cliente.getTelefone());
                System.out.println("Equipamentos vinculados:");

                for (Equipamento equipamento : equipamentosCliente) {
                    System.out.println("- " + equipamento.getNomeEquip() + " (" + equipamento.getModeloEquip() + ")");
        ...
        if (!encontrou) {
            System.out.println("Nenhum cliente possui equipamento vinculado.");
        }
    }
